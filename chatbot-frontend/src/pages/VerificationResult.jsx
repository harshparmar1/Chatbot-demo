      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            End-to-end verification review utilizing Structural Similarity Index (SSIM), keypoint tracking, and object segmenters.
          </p>
        </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="glass-panel p-4 rounded-xl border border-slate-850 space-y-1">
              <span className="text-[9px] uppercase font-bold text-slate-500 block">SSIM Similarity</span>
              <div className="text-lg font-extrabold text-teal-400">{(result.similarity_score * 100).toFixed(1)}%</div>
              <p className="text-[9px] text-slate-500 leading-tight">Structural layout matching index.</p>
            </div>

            {/* ORB Keypoint matches */}
            <div className="glass-panel p-4 rounded-xl border border-slate-850 space-y-1">
              <span className="text-[9px] uppercase font-bold text-slate-500 block">ORB Keypoints</span>
              <div className="text-lg font-extrabold text-teal-400">{result.feature_matches} Matches</div>
              <p className="text-[9px] text-slate-500 leading-tight">Keypoint texture match count.</p>
            </div>
            ...
            {/* Prediction accuracy */}
            <div className="glass-panel p-4 rounded-xl border border-slate-850 space-y-1">
              <span className="text-[9px] uppercase font-bold text-slate-500 block">ML Estimator</span>
              <div className="text-sm font-bold text-slate-300 mt-1">Random Forest</div>
              <p className="text-[9px] text-slate-500 leading-tight">Pre-trained classifier model.</p>
            </div>
