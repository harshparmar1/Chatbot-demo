    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Upload a proof image of the area. The system will compare it against the reference standard using structural similarity, feature matching, and object detection.
        </p>
      </div>
                ...
                >
                  {verifying ? (
                    <>
                      ...
                      Running CV Diff Masking & RF Classifier...
                    </>
                  ) : (
